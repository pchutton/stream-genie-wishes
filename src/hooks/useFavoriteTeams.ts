...
export const LEAGUE_TEAMS: Record<SportLeague, { name: string; espnId: string }[]> = {
  ...
  NCAAF: [
    ...
    { name: 'Washington Huskies', espnId: '264' },
    { name: 'Wisconsin Badgers', espnId: '275' },
    { name: 'Iowa Hawkeyes', espnId: '2294' },
    { name: 'Minnesota Golden Gophers', espnId: '135' },
    { name: 'Illinois Fighting Illini', espnId: '356' },
    { name: 'Purdue Boilermakers', espnId: '2509' },
    { name: 'Indiana Hoosiers', espnId: '84' },
    { name: 'Nebraska Cornhuskers', espnId: '158' },
    { name: 'Northwestern Wildcats', espnId: '77' },
    { name: 'Maryland Terrapins', espnId: '120' },
    { name: 'Rutgers Scarlet Knights', espnId: '164' },
    { name: 'Michigan State Spartans', espnId: '127' },
    // ACC
    { name: 'Clemson Tigers', espnId: '228' },
    { name: 'Florida State Seminoles', espnId: '52' },
    { name: 'Miami Hurricanes', espnId: '2390' },
    { name: 'NC State Wolfpack', espnId: '152' },
    { name: 'Louisville Cardinals', espnId: '97' },
    { name: 'Pittsburgh Panthers', espnId: '221' },
    { name: 'Syracuse Orange', espnId: '183' },
    { name: 'Virginia Tech Hokies', espnId: '259' },
    ...
    { name: 'Boston College Eagles', espnId: '103' },
    { name: 'Georgia Tech Yellow Jackets', espnId: '59' },
    // Independent
