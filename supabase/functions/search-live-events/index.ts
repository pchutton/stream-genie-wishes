...
async function fetchMultipleESPNGames(teamName: string, limit: number = 5, sportHint?: string): Promise<ESPNGameInfo[]> {
  ...
  try {
    ...
    const espnTeamMap: Record<string, { slug: string; sport: string; league: string }> = {
      ...
      'New Jersey Devils': { slug: 'njd', sport: 'nhl', league: 'team' },
      ...
      // MLS Teams (all 30 - using ESPN numeric IDs)
      'LA Galaxy': { slug: '187', sport: 'mls', league: 'usa.1' },
      'Los Angeles FC': { slug: '18966', sport: 'mls', league: 'usa.1' },
      'LAFC': { slug: '18966', sport: 'mls', league: 'usa.1' },
      'Inter Miami CF': { slug: '20232', sport: 'mls', league: 'usa.1' },
      'Inter Miami': { slug: '20232', sport: 'mls', league: 'usa.1' },
      'Seattle Sounders FC': { slug: '9726', sport: 'mls', league: 'usa.1' },
      'Seattle Sounders': { slug: '9726', sport: 'mls', league: 'usa.1' },
      'Portland Timbers': { slug: '9723', sport: 'mls', league: 'usa.1' },
      'Atlanta United FC': { slug: '18418', sport: 'mls', league: 'usa.1' },
      'Atlanta United': { slug: '18418', sport: 'mls', league: 'usa.1' },
      'New York Red Bulls': { slug: '190', sport: 'mls', league: 'usa.1' },
      'New York City FC': { slug: '17606', sport: 'mls', league: 'usa.1' },
      'NYCFC': { slug: '17606', sport: 'mls', league: 'usa.1' },
      'Columbus Crew': { slug: '183', sport: 'mls', league: 'usa.1' },
      'Philadelphia Union': { slug: '10739', sport: 'mls', league: 'usa.1' },
      'Austin FC': { slug: '20906', sport: 'mls', league: 'usa.1' },
      'Houston Dynamo FC': { slug: '6077', sport: 'mls', league: 'usa.1' },
      'Houston Dynamo': { slug: '6077', sport: 'mls', league: 'usa.1' },
      'FC Dallas': { slug: '185', sport: 'mls', league: 'usa.1' },
      'Sporting Kansas City': { slug: '186', sport: 'mls', league: 'usa.1' },
      'Minnesota United FC': { slug: '17362', sport: 'mls', league: 'usa.1' },
      'Minnesota United': { slug: '17362', sport: 'mls', league: 'usa.1' },
      'Nashville SC': { slug: '18986', sport: 'mls', league: 'usa.1' },
      'Charlotte FC': { slug: '21300', sport: 'mls', league: 'usa.1' },
      'Chicago Fire FC': { slug: '182', sport: 'mls', league: 'usa.1' },
      'Chicago Fire': { slug: '182', sport: 'mls', league: 'usa.1' },
      'CF Montreal': { slug: '9720', sport: 'mls', league: 'usa.1' },
      'CF Montréal': { slug: '9720', sport: 'mls', league: 'usa.1' },
      'Toronto FC': { slug: '7318', sport: 'mls', league: 'usa.1' },
      'Vancouver Whitecaps': { slug: '9727', sport: 'mls', league: 'usa.1' },
      'D.C. United': { slug: '193', sport: 'mls', league: 'usa.1' },
      'DC United': { slug: '193', sport: 'mls', league: 'usa.1' },
      'New England Revolution': { slug: '189', sport: 'mls', league: 'usa.1' },
      'Orlando City SC': { slug: '12011', sport: 'mls', league: 'usa.1' },
      'Orlando City': { slug: '12011', sport: 'mls', league: 'usa.1' },
      'Real Salt Lake': { slug: '4771', sport: 'mls', league: 'usa.1' },
      'Colorado Rapids': { slug: '184', sport: 'mls', league: 'usa.1' },
      'San Jose Earthquakes': { slug: '191', sport: 'mls', league: 'usa.1' },
      'St. Louis City SC': { slug: '21812', sport: 'mls', league: 'usa.1' },
      'St. Louis CITY SC': { slug: '21812', sport: 'mls', league: 'usa.1' },
      'FC Cincinnati': { slug: '18267', sport: 'mls', league: 'usa.1' },
      'San Diego FC': { slug: '22529', sport: 'mls', league: 'usa.1' },
    };
...
const teamNicknames: Record<string, string> = {
  ...
  // ============ NCAA D-I MEN'S BASKETBALL - UNIQUE KEYS ONLY ============
  // (Using basketball-specific keys to avoid conflicts with pro teams)
  
  // Blue Bloods & Elite Programs
  "jayhawks": "Kansas Jayhawks basketball", "rock chalk": "Kansas Jayhawks basketball",
  "ku basketball": "Kansas Jayhawks basketball", "kansas basketball": "Kansas Jayhawks basketball",
  "tar heels": "North Carolina Tar Heels basketball", "unc basketball": "North Carolina Tar Heels basketball",
  "heels": "North Carolina Tar Heels basketball", "carolina basketball": "North Carolina Tar Heels basketball",
  "blue devils": "Duke Blue Devils basketball", "dukies": "Duke Blue Devils basketball",
  "duke basketball": "Duke Blue Devils basketball", "cameron crazies": "Duke Blue Devils basketball",
  "kentucky basketball": "Kentucky Wildcats basketball", "uk basketball": "Kentucky Wildcats basketball",
  "uconn basketball": "UConn Huskies basketball", "connecticut basketball": "UConn Huskies basketball",
  "ucla basketball": "UCLA Bruins basketball", "ucla bruins": "UCLA Bruins basketball",
  "hoosiers": "Indiana Hoosiers basketball", "indiana basketball": "Indiana Hoosiers basketball",
  "nova": "Villanova Wildcats basketball", "villanova basketball": "Villanova Wildcats basketball",
  
  // ACC Basketball
  "orange": "Syracuse Orange basketball", "cuse": "Syracuse Orange basketball", "syracuse basketball": "Syracuse Orange basketball",
  "wahoos": "Virginia Cavaliers basketball", "uva basketball": "Virginia Cavaliers basketball", "virginia basketball": "Virginia Cavaliers basketball",
  "hokies": "Virginia Tech Hokies basketball", "vt basketball": "Virginia Tech Hokies basketball",
  "nc state basketball": "North Carolina State Wolfpack basketball",
  "demon deacons": "Wake Forest Demon Deacons basketball", "wake forest": "Wake Forest Demon Deacons basketball",
  "yellow jackets": "Georgia Tech Yellow Jackets basketball", "gt basketball": "Georgia Tech Yellow Jackets basketball",
  "louisville basketball": "Louisville Cardinals basketball", "cards basketball": "Louisville Cardinals basketball",
  "notre dame basketball": "Notre Dame Fighting Irish basketball", "nd basketball": "Notre Dame Fighting Irish basketball",
  "pitt basketball": "Pittsburgh Panthers basketball",
  "bc basketball": "Boston College Eagles basketball", "boston college basketball": "Boston College Eagles basketball",
  
  // Big Ten Basketball
  "spartans": "Michigan State Spartans basketball", "msu basketball": "Michigan State Spartans basketball",
  "sparty": "Michigan State Spartans basketball", "izzo": "Michigan State Spartans basketball",
  "michigan basketball": "Michigan Wolverines basketball", "wolverines basketball": "Michigan Wolverines basketball",
  "ohio state basketball": "Ohio State Buckeyes basketball", "buckeyes basketball": "Ohio State Buckeyes basketball",
  "boilermakers": "Purdue Boilermakers basketball", "purdue basketball": "Purdue Boilermakers basketball",
  "hawkeyes": "Iowa Hawkeyes basketball", "iowa basketball": "Iowa Hawkeyes basketball",
  "illini": "Illinois Fighting Illini basketball", "illinois basketball": "Illinois Fighting Illini basketball",
  "wisconsin basketball": "Wisconsin Badgers basketball", "badgers basketball": "Wisconsin Badgers basketball",
  "gophers": "Minnesota Golden Gophers basketball", "minnesota basketball": "Minnesota Golden Gophers basketball",
  "cornhuskers basketball": "Nebraska Cornhuskers basketball", "nebraska basketball": "Nebraska Cornhuskers basketball",
  "terrapins": "Maryland Terrapins basketball", "terps": "Maryland Terrapins basketball", "maryland basketball": "Maryland Terrapins basketball",
  "scarlet knights": "Rutgers Scarlet Knights basketball", "rutgers basketball": "Rutgers Scarlet Knights basketball",
  "nittany lions basketball": "Penn State Nittany Lions basketball",
  "northwestern basketball": "Northwestern Wildcats basketball",
  "usc basketball": "USC Trojans basketball", "trojans basketball": "USC Trojans basketball",
  "oregon basketball": "Oregon Ducks basketball", "ducks basketball": "Oregon Ducks basketball",
  "washington basketball": "Washington Huskies basketball", "huskies basketball": "Washington Huskies basketball",
  
  // Big 12 Basketball
  "red raiders": "Texas Tech Red Raiders basketball", "tech basketball": "Texas Tech Red Raiders basketball",
  "texas tech basketball": "Texas Tech Red Raiders basketball",
  "cyclones": "Iowa State Cyclones basketball", "iowa state basketball": "Iowa State Cyclones basketball",
  "horned frogs": "TCU Horned Frogs basketball", "tcu basketball": "TCU Horned Frogs basketball",
  "mountaineers": "West Virginia Mountaineers basketball", "wvu basketball": "West Virginia Mountaineers basketball",
  "bearcats": "Cincinnati Bearcats basketball", "cincy basketball": "Cincinnati Bearcats basketball", "cincinnati basketball": "Cincinnati Bearcats basketball",
  "houston basketball": "Houston Cougars basketball", "cougars basketball": "Houston Cougars basketball",
  "byu basketball": "BYU Cougars basketball", "brigham young basketball": "BYU Cougars basketball",
  "buffs basketball": "Colorado Buffaloes basketball", "colorado basketball": "Colorado Buffaloes basketball",
  "utes basketball": "Utah Utes basketball", "utah basketball": "Utah Utes basketball",
  "sun devils": "Arizona State Sun Devils basketball", "asu basketball": "Arizona State Sun Devils basketball",
  "arizona basketball": "Arizona Wildcats basketball", "zona basketball": "Arizona Wildcats basketball",
  "ucf basketball": "UCF Knights basketball", "ucf knights": "UCF Knights basketball",
  "k-state basketball": "Kansas State Wildcats basketball", "kansas state basketball": "Kansas State Wildcats basketball",
  "oklahoma state basketball": "Oklahoma State Cowboys basketball",
  "oklahoma basketball": "Oklahoma Sooners basketball", "sooners basketball": "Oklahoma Sooners basketball",
  "texas basketball": "Texas Longhorns basketball", "longhorns basketball": "Texas Longhorns basketball",
  "baylor basketball": "Baylor Bears basketball", "baylor bears": "Baylor Bears basketball",
  
  // SEC Basketball
  "alabama basketball": "Alabama Crimson Tide basketball", "bama basketball": "Alabama Crimson Tide basketball", "crimson tide basketball": "Alabama Crimson Tide basketball",
  "auburn basketball": "Auburn Tigers basketball", "war eagle basketball": "Auburn Tigers basketball",
  "razorbacks": "Arkansas Razorbacks basketball", "arkansas basketball": "Arkansas Razorbacks basketball", "hogs": "Arkansas Razorbacks basketball",
  "georgia basketball": "Georgia Bulldogs basketball", "uga basketball": "Georgia Bulldogs basketball",
  "florida basketball": "Florida Gators basketball", "gators basketball": "Florida Gators basketball",
  "tennessee basketball": "Tennessee Volunteers basketball", "vols basketball": "Tennessee Volunteers basketball",
  "gamecocks basketball": "South Carolina Gamecocks basketball", "south carolina basketball": "South Carolina Gamecocks basketball",
  "lsu basketball": "LSU Tigers basketball", "louisiana state basketball": "LSU Tigers basketball",
  "ole miss basketball": "Ole Miss Rebels basketball", "mississippi basketball": "Ole Miss Rebels basketball",
  "miss state basketball": "Mississippi State Bulldogs basketball", "mississippi state basketball": "Mississippi State Bulldogs basketball",
  "mizzou basketball": "Missouri Tigers basketball", "missouri basketball": "Missouri Tigers basketball",
  "commodores basketball": "Vanderbilt Commodores basketball", "vandy basketball": "Vanderbilt Commodores basketball", "vanderbilt basketball": "Vanderbilt Commodores basketball",
  "texas a&m basketball": "Texas A&M Aggies basketball", "aggies basketball": "Texas A&M Aggies basketball", "tamu basketball": "Texas A&M Aggies basketball",
  
  // Big East Basketball (National TV staple)
  "bluejays": "Creighton Bluejays basketball", "creighton basketball": "Creighton Bluejays basketball",
  "hoyas": "Georgetown Hoyas basketball", "georgetown basketball": "Georgetown Hoyas basketball",
  "musketeers": "Xavier Musketeers basketball", "xavier basketball": "Xavier Musketeers basketball",
  "red storm": "St. John's Red Storm basketball", "st johns basketball": "St. John's Red Storm basketball",
  "friars": "Providence Friars basketball", "providence basketball": "Providence Friars basketball",
  "seton hall basketball": "Seton Hall Pirates basketball",
  "golden eagles": "Marquette Golden Eagles basketball", "marquette basketball": "Marquette Golden Eagles basketball",
  "blue demons": "DePaul Blue Demons basketball", "depaul basketball": "DePaul Blue Demons basketball",
  "butler basketball": "Butler Bulldogs basketball", "butler bulldogs": "Butler Bulldogs basketball",
  
  // Mid-Major Powers (March Madness regulars with TV exposure)
  "zags": "Gonzaga Bulldogs basketball", "gonzaga basketball": "Gonzaga Bulldogs basketball", "gonzaga bulldogs": "Gonzaga Bulldogs basketball",
  "aztecs": "San Diego State Aztecs basketball", "sdsu basketball": "San Diego State Aztecs basketball", "san diego state basketball": "San Diego State Aztecs basketball",
  "billikens": "Saint Louis Billikens basketball", "slu basketball": "Saint Louis Billikens basketball",
  "shockers": "Wichita State Shockers basketball", "wichita state basketball": "Wichita State Shockers basketball",
  "gaels": "Saint Mary's Gaels basketball", "saint marys basketball": "Saint Mary's Gaels basketball", "st marys basketball": "Saint Mary's Gaels basketball",
  "vcu basketball": "VCU Rams basketball", "virginia commonwealth basketball": "VCU Rams basketball",
  "dayton basketball": "Dayton Flyers basketball", "dayton flyers": "Dayton Flyers basketball",
  "bonnies": "St. Bonaventure Bonnies basketball", "st bonaventure basketball": "St. Bonaventure Bonnies basketball",
  "utah state basketball": "Utah State Aggies basketball",
  "lobos": "New Mexico Lobos basketball", "new mexico basketball": "New Mexico Lobos basketball",
  "memphis basketball": "Memphis Tigers basketball", "memphis tigers": "Memphis Tigers basketball",
  "mean green": "North Texas Mean Green basketball", "unt basketball": "North Texas Mean Green basketball",
